...
export const TelemetryView: React.FC<TelemetryDTOType> = ({ telemetry }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center">
      ...
      <div className="m-4 flex h-32 w-32 items-center justify-center rounded-full bg-gray-500 text-center text-white">
        <div>
          Latitude: <span className="block">{telemetry.lat}</span>
        </div>
      </div>
      <div className="m-4 flex h-32 w-32 items-center justify-center rounded-full bg-gray-500 text-center text-white">
        <div>
          Longitude: <span className="block">{telemetry.lon}</span>
        </div>
      </div>
      <div className="m-4 flex h-32 w-32 items-center justify-center rounded-full bg-gray-500 text-center text-white">
        <div>
          Altitude: <span className="block">{telemetry.altitude}</span>
        </div>
      </div>
      <div className="m-4 flex h-32 w-32 items-center justify-center rounded-full bg-gray-500 text-center text-white">
        <div>
          ...
          >
            {telemetry.status ? 'Open' : 'Closed'}
          </span>
        </div>
      </div>
      <div className="m-4 flex h-32 w-32 items-center justify-center rounded-full bg-gray-500 text-center text-white">
        <div>
          Power: <span className="block">{telemetry.power}</span>
        </div>
      </div>
    </div>
  );
